...
<head>
    <style>
        body{
            background-image: url(bookdisplay.jpg);
        }
        </style>
    <meta charset="utf-8">
                ...
                <a href="bookdisplay1.php" class="nav-item nav-link active">Home</a>
                    ...
                    <!-- <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-black" href="#" id="navbarDropdown" role="button"
                            data-mdb-toggle="dropdown" aria-expanded="false"> <i class="fas fa-user mx-1"></i> Report
                        </a>
                    
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                            <li>
                                <a class="dropdown-item" href="confirmreport.php">Confirm order</a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="uploadreport.php">Upload order</a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="interestreport.php">Interest</a>
                            </li>

                            <li>
                                <a class="dropdown-item" href="userreport.php">user</a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="bookdisplay.php">Log out</a>
                            </li>
                        </ul>
                    </li> -->
...
echo "<td><img src=$row[11] height=300 width=350><hr>title:$row[2]<br>language:$row[5]<br>edition:$row[6]<br>publication:$row[7]<br>author:$row[8]<br>original_price:$row[9]<br>selling_price:$price<br>upload by:$un<br>emailid:$em</td>";
...
?><hr>
<center>
<input type=submit name=sbm value=Request class="btn btn-primary py-2 px-4 ms-3">
<a href="searching.php"><input type=button value=Previous class="btn btn-primary py-2 px-4 ms-3"></a>
</center>
</form>
</body>
</html>
